...
export default function NorthernBeachesPageClient() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="py-6 px-4 bg-background/95 backdrop-blur-sm border-b border-border sticky top-0 z-50">
        <div className="container mx-auto max-w-6xl">
          <div className="flex items-center space-x-2">
            <Image src="/JOURN3Y-logo.svg" alt="JOURN3Y Logo" width={40} height={40} />
      ...
      <section className="relative py-8 md:py-24 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute bottom-20 -right-20 w-40 h-40 md:w-96 md:h-96 bg-secondary/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />

        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
            <div className="space-y-3 md:space-y-6 animate-fade-in opacity-0" style={{ animationDelay: '0.2s' }}>
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight break-words">
                Find 5-10 Hours Per Week for{' '}
              ...
              <div className="pt-2 md:pt-4">
                <Button
                  size="lg"
                  className="text-sm sm:text-base md:text-lg px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 w-full md:w-auto bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:opacity-90 hover:scale-105 transition-all shadow-lg hover:shadow-xl group"
                  asChild
            ...
            <div className="relative animate-fade-in opacity-0 mt-6 md:mt-0" style={{ animationDelay: '0.4s' }}>
      ...
      <section className="py-12 md:py-24 px-4 bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-8 md:mb-12">
            ...
            <Button
              size="lg"
              className="text-base md:text-xl px-8 py-6 md:px-12 md:py-8 w-full sm:w-auto bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:opacity-90 transition-opacity shadow-xl mb-6 md:mb-8"
              asChild
            ...
            <Card className="p-6 md:p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
                ...
                <Button
                  ...
                  className="w-full text-base md:text-lg py-5 md:py-6 bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:opacity-90 transition-opacity"
                >
      ...
      <footer className="py-8 px-4 bg-foreground text-background">
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-sm">
            © {new Date().getFullYear()} JOURN3Y. All rights reserved. | Northern Beaches, Sydney
          </p>
        </div>
      </footer>
    </div>
