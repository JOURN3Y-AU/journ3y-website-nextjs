...
import { CheckCircle, Clock, Users, TrendingUp, X, Search, Zap, Shield, SquarePen } from 'lucide-react'
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components/ui/dialog'
import { supabase } from '@/lib/supabase/client'

export default function LinkedInGleanPageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/?${conversionParams.toString()}`)
        ...
        <header className="py-4 px-4">
          <div className="container mx-auto">
            <div className="flex items-center justify-between">
              <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-journey-purple to-journey-blue bg-clip-text text-transparent">
                JOURN3Y
              </Link>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-start space-x-3">
                    <SquarePen className="w-6 h-6 text-blue-600 mt-1 flex-shrink-0" />
                    <div>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8 border border-blue-100">
                <h2 className="text-2xl font-bold mb-2">Learn more about Glean</h2>
